...
region_1 <- "Southwestern Europe"
region_2 <- "Northwestern Europe"

name <- "Southwestern & Northwestern Europe"
...
ggsave("results/europe_north_south.png", plot = plot_trend, dpi = 300, width = 10, height = 8)
