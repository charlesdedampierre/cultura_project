...
plot_trend <- plot_trends(df_decade, df_indi, region_name, min_date, max_date, span, capita = "False", name)
...
ggsave("results_per_capita/Italy.png", plot = plot_trend_population, dpi = 300, width = 10, height = 8)
