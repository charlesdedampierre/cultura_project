...
plot_trend <- plot_trends(df_decade, df_indi, region_name, min_date, max_date, capita = FALSE, name)
ggsave("results/Eastern Europe.png", plot = plot_trend, dpi = 300, width = 10, height = 8)
...
plot_trend_population <- plot_trends(df_decade_poulation, df_indi, region_name, min_date, max_date, capita = TRUE, name)
ggsave("results_per_capita/Eastern Europe.png", plot = plot_trend_population, dpi = 300, width = 10, height = 8)
