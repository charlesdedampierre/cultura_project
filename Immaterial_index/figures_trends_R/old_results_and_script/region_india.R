...
plot_trends <- function(df_decade, df_indi, region_name, min_time, max_time, capita, name, time_size = 15) {
...
ggsave("results/Indian world.png", plot = plot_trend, dpi = 300, width = 10, height = 8)
...
ggsave("results_per_capita/Indian world.png", plot = plot_trend_population, dpi = 300, width = 10, height = 8)
