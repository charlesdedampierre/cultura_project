...
ggsave("results/Slav world.png", plot = plot_trend, dpi = 300, width = 10, height = 8)
...
ggsave("results_per_capita/Slav world.png", plot = plot_trend_population, dpi = 300, width = 10, height = 8)
