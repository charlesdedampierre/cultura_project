...
region_1 <- "Persian world"
region_2 <- "Arabic world"

name <- "Persian and Arabic worlds"
...
ggsave("results/mena_persian_arab.png", plot = plot_trend, dpi = 300, width = 10, height = 8)
