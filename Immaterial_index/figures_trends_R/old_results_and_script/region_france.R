...
plot_trend <- plot_trends(df_decade, df_indi, region_name, min_date, max_date, span, name, capita = FALSE)
ggsave("results/France.png", plot = plot_trend, dpi = 300, width = 10, height = 8)
...
ggsave("results_per_capita/France.png", plot = plot_trend_population, dpi = 300, width = 10, height = 8)
