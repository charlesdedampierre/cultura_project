...
plot_trends <- function(df_decade, df_indi, region_name, min_time, max_time, span) {
  ...
  myplot <- ggplot(df_decade, aes(x = decade, y = score, color = region_name)) +
    ...
    geom_text(aes(x = -163.5, y = 35, size = 7), label = "Republican era", color = "grey80", angle = 90, vjust = 0.5, hjust = 0) +
    geom_text(aes(x = 20.5, y = 35, size = 7), label = "Julio-Claudian dynasty ", color = "grey80", angle = 90, vjust = 0.5, hjust = 0) +
    # geom_text(aes(x = -12.5, y = 35, size = 7), label = "Augustin era", color = "grey80", angle = 90, vjust = 0.5, hjust = 0) +
    geom_text(aes(x = 82.5, y = 35, size = 7), label = "Flavian dynasty", color = "grey80", angle = 90, vjust = 0.5, hjust = 0) +
    geom_text(aes(x = 144, y = 35, size = 7), label = "Nerva–Antonine dynasty", color = "grey80", angle = 90, vjust = 0.5, hjust = 0) +
    geom_text(aes(x = 213.5, y = 35, size = 7), label = "Severan dynasty", color = "grey80", angle = 90, vjust = 0.5, hjust = 0) +
