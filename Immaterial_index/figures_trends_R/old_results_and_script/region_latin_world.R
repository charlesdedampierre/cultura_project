...
plot_trends <- function(df_decade, df_indi, region_name, min_time, max_time, capita = FALSE, name, time_size = 15) {
    ...
    text_position <- y_range[1] + 2 / 3 * diff(y_range)
...
ggsave("results/Latin World.png", plot = plot_trend, dpi = 300, width = 10, height = 8)
...
ggsave("results_per_capita/Latin World.png", plot = plot_trend_population, dpi = 300, width = 10, height = 8)
