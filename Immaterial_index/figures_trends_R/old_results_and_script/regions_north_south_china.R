...
region_1 <- "Southern China"
region_2 <- "Northern China"

name <- "Southern and Northern China"
...
ggsave("results/china_north_south.png", plot = plot_trend, dpi = 300, width = 10, height = 8)
