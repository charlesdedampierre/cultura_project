...
ggsave("results/Balkans.png", plot = plot_trend, dpi = 300, width = 10, height = 8)
...
ggsave("results_per_capita/Balkans.png", plot = plot_trend_population, dpi = 300, width = 10, height = 8)
