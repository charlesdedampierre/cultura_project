...
ggsave("results_unseen/japan.png", plot = plot_trend_unseen, dpi = 300, width = 10, height = 8)
...
plot_trend_unseen <- plot_trends(df_unseen, df_indi, region_name, min_date, max_date, span = 0.1, name, capita = "True", time_size = 15, text_position = 1.1)
ggsave("results_unseen/per_capita/japan.png", plot = plot_trend_unseen, dpi = 300, width = 10, height = 8)
