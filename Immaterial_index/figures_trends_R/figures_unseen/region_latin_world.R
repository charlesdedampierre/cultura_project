...
ggsave("results_unseen/latin_world.png", plot = plot_trend_unseen, dpi = 300, width = 10, height = 8)
...
ggsave("results_unseen/per_capita/latin_world.png", plot = plot_trend_unseen, dpi = 300, width = 10, height = 8)
