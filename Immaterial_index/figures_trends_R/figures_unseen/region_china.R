...
plot_trends <- function(df_decade, df_indi, region_name, min_time, max_time, span, name, capita = "True", time_size = 15, text_position = 5) {
    ...
    myplot <- ggplot(df_decade, aes(x = decade, y = score, color = region_name)) +
        ...
        # geom_vline(xintercept = c(960, 1270), linetype = "dashed", color = "grey80") + # Song dynasty
        geom_vline(xintercept = c(960, 1127), linetype = "dashed", color = "grey80") + # Nothern Song dynasty
        geom_vline(xintercept = c(1127, 1279), linetype = "dashed", color = "grey80") + # southern Song dynasty
        geom_vline(xintercept = c(1279, 1368), linetype = "dashed", color = "grey80") + # Yuan dynasty
        ...
        geom_text(aes(x = 1043, y = text_position, size = 7), label = "Northern Song dynasty", color = "grey80", angle = 90, vjust = 0.5, hjust = 0.5) +
        geom_text(aes(x = 1203, y = text_position, size = 7), label = "Southern Song dynasty", color = "grey80", angle = 90, vjust = 0.5, hjust = 0.5) +
        # geom_text(aes(x = 1115, y = text_position, size = 7), label = "Song dynasty", color = "grey80", angle = 90, vjust = 0.5, hjust = 0.5) +
        geom_text(aes(x = 1319, y = text_position, size = 7), label = "Yuan dynasty", color = "grey80", angle = 90, vjust = 0.5, hjust = 0.5) +
...
plot_trend_unseen <- plot_trends(df_unseen, df_indi, region_name, min_date, max_date, span = 0.1, name, capita = "True", time_size = 8, text_position = 1.9)
ggsave("results_unseen/per_capita/china.png", plot = plot_trend_unseen, dpi = 300, width = 10, height = 8)
